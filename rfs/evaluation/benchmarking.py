...
def run_fast_benchmark_suite(
    ...
    aggregate = {
        ...
        "formula_total": sum(int(value) for value in extraction_metric("formula_count")),
        ...
        "ocr_attempted_page_total": sum(int(value) for value in extraction_metric("ocr_attempted_count")),
        ...
        "native_hyphenation_repair_total": sum(int(value) for value in extraction_metric("native_hyphenation_repair_count")),
        ...
        "mean_ocr_latin_known_word_ratio": _mean(extraction_metric("ocr_latin_known_word_ratio")),
