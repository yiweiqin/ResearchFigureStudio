...
def build_parser() -> argparse.ArgumentParser:
    ...
    paper_image.add_argument("--template", choices=["auto", "multimodal", "branch", "feedback", "arbor", "linear", "tripanel", "dense-multimodal"], default="auto", help="Reference architecture template. Default: auto selection.")
    ...
    paper_editable.add_argument("--template", choices=["auto", "multimodal", "branch", "feedback", "arbor", "linear", "tripanel", "dense-multimodal"], default="auto")
