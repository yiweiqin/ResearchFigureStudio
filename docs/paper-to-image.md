...
For a fully scanned long paper with no native section signals, the six-page fallback schedule covers pages 1-4 first, then a middle page and a page near 85% of the document. This biases scarce OCR time toward the abstract, overview figure, and early method details while retaining mid/late-document coverage.
